...
import { ArrowLeft, ChevronDown, ChevronUp, Globe, Lock, User, Users } from 'lucide-react'
...
export function SkillDetailPage() {
  ...
  const { data: skillTranslations } = useSkillTranslations(namespace, slug, detailQueriesEnabled && Boolean(skill?.canManageLifecycle))
