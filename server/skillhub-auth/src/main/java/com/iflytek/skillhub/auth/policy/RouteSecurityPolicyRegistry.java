...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skills/*/*/versions/*"),
                RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/skills/*/*/download"),
                RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/skills/*/*/versions/*/download"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skills/*/*/labels"),
                RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/skills/*/*/tags/*/download"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skills/*/*/versions/*"),
                RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/web/skills/*/*/download"),
                RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/web/skills/*/*/versions/*/download"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skills/*/*/labels"),
                RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/web/skills/*/*/tags/*/download"),
