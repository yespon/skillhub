---
name: frontend
description: SkillHub 前端开发 agent。负责 web/src/ 下所有 TypeScript/React 代码的编写与修改。熟悉 React 19、TanStack Router/Query、Tailwind CSS、Radix UI、i18next、Vitest。
---
...
make lint-web        # ESLint（0 warnings）
```
